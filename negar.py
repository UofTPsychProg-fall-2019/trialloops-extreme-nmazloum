...
expName = 'negar'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/seyeeh-negarmazloomfarzaghi/OneDrive - University of Toronto/MA/UofT Classes/Programming Class/fastFace/faces/negar.py',
...
trials = data.TrialHandler(nReps=5, method='random', 
    ...
    trialList=data.importConditions('../../../../../../Desktop/faceConds.csv'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if target.status == STARTED:
            ...
            if tThisFlipGlobal > target.tStartRefresh + 2-frameTolerance:
        ...
        if response.status == STARTED and not waitOnFlip:
            theseKeys = response.getKeys(keyList=['m', 'f'], waitRelease=False)
            if len(theseKeys):
                theseKeys = theseKeys[0]  # at least one key was pressed
